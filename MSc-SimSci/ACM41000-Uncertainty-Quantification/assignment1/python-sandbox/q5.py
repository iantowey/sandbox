...
a = 1.5
b = 0.9
sol = optimize.root(fun = f,x0 = [0], args = (a, b), method = 'hybr')

,((2,3.5),'2',3),((3.1,2.5),'3',3),((3.1,0.5),'4',3),((1.5,3.5),'5',3),((1.1,0.01),'6',50)
...
plt.show()
plt.savefig('/home/ian/Desktop/ACM41000-Uncertainty-Quantification/assignment1/3D_plot.png')
